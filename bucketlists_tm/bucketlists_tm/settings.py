"""
Django settings for bucketlists_tm project.
...
SECRET_KEY = ')gy3bkvzcd5$rh*gs8viwrvrw&d=cg75+r(ru&4#2!n#w&gp8d'
...
ROOT_URLCONF = 'bucketlists_tm.urls'
...
WSGI_APPLICATION = 'bucketlists_tm.wsgi.application'
